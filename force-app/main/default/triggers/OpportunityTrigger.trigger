...
*/
trigger OpportunityTrigger on Opportunity (before insert, before update, after update, after insert, before delete, after undelete) {


if (Trigger.isBefore && Trigger.isUpdate){ 
    OpportunityTriggerHandler.setPrimaryContact(Trigger.newMap);
    OpportunityTriggerHandler.amountValidation(Trigger.new);
}

if (Trigger.isBefore && Trigger.isUpdate){
    OpportunityTriggerHandler.updateDescriptionFromStage(Trigger.new); // tried it as trigger.oldmap and it failed the test, trying trigger.newMap
    }
...
//    OpportunityTriggerHandler.notifyOwnersOpportunityDeleted(Trigger.newMap);
//}
